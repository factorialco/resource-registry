  ...
  describe "#call" do
    ...
    context "with a enum field dto" do
      ...
      it "is populated with the correct deserialized enum" do
        result = subject
        expect(result.enum_field).to eq(
          ResourceRegistry::DtoBuilderSpec::Dtos::EnumTest::One
        )
      end
    end
    ...
    context "with an invalid enum field dto" do
      ...
      it "raises a parse error" do
        expect { subject }.to raise_error(
          ResourceRegistry::ResourceStructBuilder::ParseInputError
        )
      end
    end
    ...
    context "with maybe values" do
      ...
      it "observes maybe values correctly" do
        result =
          T.let(subject, ResourceRegistry::DtoBuilderSpec::Dtos::NestedMaybeDto)
        ...
        simple_maybe_dto =
          T.cast(
            ...
            Maybe::Present[
              ResourceRegistry::DtoBuilderSpec::Dtos::SimpleMaybeDto
            ]
          ).value
    ...
    context "with nested nilable values" do
      let(:dto) do
        ResourceRegistry::DtoBuilderSpec::Dtos::NestedNilableSimpleMaybeDto
      end
      let(:args) do
        {
          basic: "one-type",
