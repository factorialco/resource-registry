...
module SchemaRegistry
  class JsonSchemaMapper
    ...
    def call
      ...
      Schema.new(
        ...
        additional_filter_fields:
          handle_fields(definition[key]["additional_filter_fields"])
      )
    end
    ...
    def handle_items(items)
      ...
      [
        SchemaRegistry::Property.new(
          ...
          properties:
            handle_properties(items["properties"], items["required"]) || [],
    ...
    sig do
      params(input: T.nilable(T::Array[T::Hash[String, T.untyped]])).returns(
        T::Array[FilterField]
      )
    end
    ...
    def handle_properties(properties, required)
      properties&.map do |key, value|
        ...
        SchemaRegistry::Property.new(
          ...
          properties:
            handle_properties(value["properties"], value["required"]) || [],
          required: required ? required.include?(key) : false,
          serialization_groups:
            handle_serialization_groups(value["serialization_groups"])
        )
      end
    end
    ...
    sig do
      params(prop_type: T.any(String, T::Array[String])).returns(T::Boolean)
    end
    ...
    sig do
      params(
        resolver: T.any(NilClass, String, T::Hash[Symbol, String])
    ...
    sig do
      params(serialization_groups: T.any(NilClass, T::Array[String])).returns(
        T::Set[Symbol]
      )
    end
    ...
    def type_to_sorbet(json_schema_type, format)
      ...
      when "object"
        ...
        raise UnrecognizedJsonSchemaTypeError,
              "unrecognized type #{json_schema_type}"
      end
    end
